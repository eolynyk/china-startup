  ...
  AccountsEntry.config({
    ...
    extraSignUpFields: [
      {             // Add extra signup fields on the signup page
        ...
        field: "SkypeID",                           // The database property you want to store the data in
        //name: "This Will Be The Initial Value",  // An initial value for the field, if you want one
        label: "SkypeID",                      // The html lable for the field
        placeholder: "echo123",                 // A placeholder for the field
        type: "text",                            // The type of field you want
        required: true 
      }
    ]
